define('we/plugins/dialog/1.0.0/jquery-dialog/jquery-dialog-plugins',function (require, exports, module) {
    ...
    (function ($) {
         ...
         */
        $.alert = $.dialog.alert = function (content, type, time, callback,options) {
			var op = $.extend({
				zIndex:1989
			},options);
        	var time_def = 3000,
