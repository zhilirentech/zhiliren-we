...
public class AccessCore {
    ...
    /**
     * 验证消息是否是统一平台发出的合法消息
     * @param sPara 通知返回来的参数数组
     * @param signKey 签名 秘钥
     * @return 验证结果
     */
    public static boolean verify(Map<String, String> sPara,String signKey) {
    	 //////1,得到请求端发送的签名信息//////
		String sign = sPara.get("sign") ;
		
        //生成签名结果
        String mysign = sign(sPara,signKey);
     ...
     * @return 签名结果字符串
     */
	public static String sign(Map<String, String> sPara,String signKey) {
        ...
        String mysign = MD5.sign(prestr, signKey, AccessConfig.INPUT_CHARSET);
        System.out.println("签名值:" + mysign); 
        return mysign;
    }
}
