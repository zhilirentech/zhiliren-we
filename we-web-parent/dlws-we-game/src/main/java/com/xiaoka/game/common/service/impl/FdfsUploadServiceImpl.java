package com.xiaoka.game.common.service.impl;
...
import com.xiaoka.game.common.service.BaseUploadService;

@IocBean(name = "fdfsUploadService")
public class FdfsUploadServiceImpl extends BaseUploadService {

	@Override
	public String uploadImage(InputStream inStream, String file_ext_name,
