...
(function(root, factory) {
    ...
    var defaults = {
        ...
        DATE_DIS_TPL = '<span>{year}年</span><span class="m">{month}月</span>',

        ITEM_STYLE = 'style="width:{w}px;height:{h}px;line-height:{h}px"',
        WEEK_ITEM_TPL = '<li ' + ITEM_STYLE + '><span>{wk}</span></li>',
        DAY_ITEM_TPL = '<li ' + ITEM_STYLE + '><span class="{class}" {action}>{value}</span></li>',
