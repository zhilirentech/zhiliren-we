...
<div class="panel_box">
	<div class="panel_content nopadding">
		<form method="post" action="${base}/admin/message/update.html" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
			<input name="id" type="hidden" value="${obj.message.id}"/>
			
			<div class="form_item">
				<label class="form_label">标题：</label>
			  	<div class="form_ctrl">
			    	<input name="title" type="text" class="required"  maxlength="10" value="${obj.message.title}"/>
			  	</div>
			</div>
			...
			<div class="form_item">
				...
				<div class="form_ctrl" >
					<textarea name="content" id="editor">${obj.message.content}</textarea>
				</div>
			</div>
...
<script type="text/javascript">
	window.xiaokaBasePath ="<%=contextPath%>";
</script>
...
$(document).ready(function(){
	var urllist = [] ;
	//urllist.push('${obj.message.title}');
