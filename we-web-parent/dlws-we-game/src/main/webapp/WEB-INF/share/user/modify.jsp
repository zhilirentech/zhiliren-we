...
<div class="panel_box">
	<div class="panel_content nopadding">
		<form method="post" action="/share/user/modify.json" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
			<input type="hidden" name="id" value="${obj.id }"/> 
			<div class="form_item">
				<label class="form_label">用户名：</label>
              	<div class="form_ctrl">
                	<input readonly="readonly" name="username" type="text" class="required chars" value="${obj.username }"/>
              	</div>
            </div>
            <div class="form_item">
